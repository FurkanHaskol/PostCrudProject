<x-app-layout>
    ...
    <div class="py-12">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form method="post" action="{{ route('post.add') }}" class="mt-6 space-y-6">
        @csrf
        ...
        <div>
            ...
            <x-text-input required id="post_description" name="post_description" type="text" class="mt-1 block w-full"/>
